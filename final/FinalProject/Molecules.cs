...
public abstract class Molecules {
    private List<string> _moleculesFormula = new List<string> {"CH3OH", "C2H5OH", "C3H7OH", "C4H9OH", "C5H11OH", "CH3COCH3", "C4H8O", "C4H8O", "C5H10O", "C6H12O", "C6H6", "C7H8", "C8H10", "C10H8", "C14H10", "HCOOH", "CH3COOH", "C2H5COOH", "C3H7COOH", "C4H9COOH", "CH2O", "CH3CHO", "C3H7CHO", "C4H9CHO", "C5H11CHO", "C6H5NH2", "C7H9NH2", "C4H11N", "C3H9N", "C5H11N"};
    ...
    public string ShowName(int index) {
        string nameMolecule = $"Name of the Molecule: {_moleculesName[index]} ({_moleculesFormula[index]})";
        return nameMolecule;
    }
    public bool Reload() {
